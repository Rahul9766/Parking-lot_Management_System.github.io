...
class UI{
    ...
    static validateInputs(){
        ...
        var licensePlateRegex = /^(?:[a-zA-Z]{2}-\d{2}-[a-zA-Z]{2}-\d{4})$/;
...
//This class allows you to store and retrieve entries with license plate in the browser's local storage and also allows you to add and remove entries based on the license plate.
